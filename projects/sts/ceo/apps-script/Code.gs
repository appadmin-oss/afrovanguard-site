...
// Fail CLOSED: if SHARED_KEY is not configured, reject rather than allow.
// A missing key previously turned this ANYONE_ANONYMOUS web app into an open,
// unauthenticated write/mail endpoint. Set the SHARED_KEY script property to
// the same value as the PHP side's STS_APPS_SCRIPT_KEY.
