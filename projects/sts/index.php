  ...
  <div class="hero-v2__inner">
    ...
    <div class="hero-v2__copy">
      <span class="hero-v2__pill reveal" style="--i:0">
        ...
        Active in <?= (int) sts_org('lgas') ?> Lagos LGAs&nbsp;&middot;&nbsp;<?= htmlspecialchars(sts_term_label()) ?>
      </span>
    ...
    <div class="hero-v2__photos reveal" style="--i:2">
      <div class="hero-v2__stack-wrap">
        <div class="hero-v2__stat-badge" aria-hidden="true">
          <strong><?= sts_k(sts_stat('children_reached')) ?></strong>
...
</div> </div> <div class="stats-grid" data-stats-grid=""> <div class="stat"> <div class="stat-numeral"> <span data-count="<?= sts_stat('children_reached') ?>" data-stat-key="children_reached">0</span> </div> <div class="stat-label">Children reached</div> <div class="stat-foot">Across all programs, cumulative since 2021</div> </div> <div class="stat"> <div class="stat-numeral"> <span data-count="<?= sts_stat('schools_engaged') ?>" data-stat-key="schools_engaged">0</span> </div> <div class="stat-label">Schools engaged</div> <div class="stat-foot">Public + community schools in Alimosho, Ikeja, Kosofe, Agege</div> </div> <div class="stat"> <div class="stat-numeral"> <span data-count="<?= sts_stat('sessions_delivered') ?>" data-stat-key="sessions_delivered">0</span> </div> <div class="stat-label">Sessions delivered</div> <div class="stat-foot">Workshops, clinics and field events in the 2024–25 cycle</div> </div> <div class="stat"> <div class="stat-numeral"> <span data-count="<?= sts_stat('literacy_improvement') ?>" data-stat-key="literacy_improvement">0</span> <span class="stat-suffix">%</span> </div> <div class="stat-label">Literacy improvement</div> <div class="stat-foot">LCASP cohort, baseline to endline within one term</div> </div> </div> </div> </section> <section class="section what-section" data-screen-label="03 Programs"> <div class="section-inner"> <div class="what-head"> <div> <span class="eyebrow reveal">Our programs</span> <h2 class="section-title reveal">Four programs. One framework. Designed for the children Lagos overlooks.</h2> <p class="section-lede reveal">Each delivers a measurable outcome within a school term. Pick a path to see the methodology and results.</p> </div> <div class="reveal"> <a class="btn btn-ghost" href="/programs">All programs <span class="btn-arrow">→</span></a> </div> </div> <div class="programs-grid"><?php foreach (sts_programs() as $p): ?> <div class="reveal"> <a class="program-card" href="/programs/<?= $p['slug'] ?>"> <div class="placeholder card-ph"><img alt="<?= htmlspecialchars($p['name']) ?>" loading="lazy" src="<?= $p['img'] ?>" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;z-index:2;"/></div> <div class="program-body"> <div class="program-name"> <span><?= htmlspecialchars($p['name']) ?></span> <span class="program-arrow">&rarr;</span> </div> <p class="program-desc"><?= htmlspecialchars($p['desc']) ?></p> <div class="program-meta"> <strong><?= htmlspecialchars($p['metric']) ?></strong> <span><?= htmlspecialchars($p['metric_label']) ?></span> <span style="margin-left: auto;"><span class="program-pill"><?= htmlspecialchars($p['pill']) ?></span></span> </div> </div> </a> </div><?php endforeach; ?></div> </div> </section> <section class="section how-section" data-screen-label="04 Methodology"> <div class="section-inner"> <div class="pillars-head"> <div> <span class="eyebrow reveal">How we work</span> <h2 class="section-title reveal" style="font-size: clamp(28px, 3.4vw, 36px);">Five pillars. The same across every program.</h2> </div> <p class="section-lede reveal" style="margin-top: 0;">
...
<em>Measured against assessments administered at intake using a partner-verified instrument. Endline data collected September 2025. Full methodology and per-school breakdown forthcoming in the 2025 annual report.</em> <a class="evidence-cta" href="/impact">Read the methodology <span aria-hidden="true">→</span></a> </div> </div> </div> </section> <section class="section latest-section" data-screen-label="06 Latest"> <div class="section-inner"> <div class="latest-head"> <div> <span class="eyebrow reveal">Latest from the field</span> <h2 class="section-title reveal">Field notes, methodology, and the parts we're still figuring out.</h2> </div> <div class="reveal"> <a class="btn btn-ghost" href="/blog">Read the blog <span class="btn-arrow">→</span></a> </div> </div> <div class="latest-grid"><?php foreach (sts_posts(3) as $post): ?> <div class="reveal"> <a class="post-card" href="/blog/<?= $post['slug'] ?>"> <div class="placeholder"><img alt="<?= htmlspecialchars($post['title']) ?>" loading="lazy" src="<?= $post['img'] ?>" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;z-index:2;"/></div> <div class="post-meta"> <span class="post-cat"><?= htmlspecialchars($post['cat']) ?></span> <span class="sep">&middot;</span> <span><?= htmlspecialchars($post['date']) ?></span> </div> <div class="post-title"><?= htmlspecialchars($post['title']) ?></div> <p class="post-excerpt"><?= htmlspecialchars($post['excerpt']) ?></p> </a> </div><?php endforeach; ?></div> </div> </section> <section class="section gi-section" data-screen-label="07 Get involved"> <div class="section-inner"> <div class="gi-head"> <span class="eyebrow reveal">Get involved</span> <h2 class="section-title reveal">Four ways to help. None of them start with "donate now".</h2> <p class="section-lede reveal">
...
</p> </div> <div class="gi-grid"> <div class="reveal"> <a class="gi-tile" href="/get-involved/volunteer"> <div> <div class="gi-tile-num">01 / 04</div> <div class="gi-tile-title">Volunteer</div> </div> <div> <div class="gi-tile-fact"><?= sts_n(sts_stat('active_volunteers')) ?> active volunteers across teaching, mentoring and back-office roles.</div> <div class="gi-tile-arrow" style="margin-top: 16px;">
Open pathway <span aria-hidden="true">→</span> </div> </div> </a> </div><div class="reveal"> <a class="gi-tile" href="/get-involved/partner"> <div> <div class="gi-tile-num">02 / 04</div> <div class="gi-tile-title">Partner</div> </div> <div> <div class="gi-tile-fact"><?= sts_n(sts_stat('institutional_partners')) ?> institutional partners: schools, faith bodies, community NGOs.</div> <div class="gi-tile-arrow" style="margin-top: 16px;">
Open pathway <span aria-hidden="true">→</span> </div> </div> </a> </div><div class="reveal"> <a class="gi-tile" href="/get-involved/sponsor"> <div> <div class="gi-tile-num">03 / 04</div> <div class="gi-tile-title">Sponsor</div> </div> <div> <div class="gi-tile-fact"><?= sts_n(sts_stat('children_sponsored')) ?> children currently sponsored. Term-by-term reporting to every sponsor.</div> <div class="gi-tile-arrow" style="margin-top: 16px;">
