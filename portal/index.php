          ...
          <section class="pcard tool-meet" id="tlMeet" data-csrf="<?= e($collabCsrf) ?>">
            ...
            <div class="pcard-body">
              <form id="tlMeetForm" class="meet-form" autocomplete="off">
                ...
                <p class="meet-hint">A join link is created automatically — Google Meet when your Workspace calendar is connected, otherwise a built-in Afrovanguard room. Minutes are generated by Gemini Flash from the Google Meet transcript, an uploaded recording, or pasted text.</p>
              </form>
