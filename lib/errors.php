...
.err-illo .fallback .big{font-family:'Cormorant SC',Georgia,serif;font-size:clamp(72px,14vw,128px);line-height:.9}
...
.err-title{font-family:'Cormorant SC',Georgia,serif;font-size:clamp(40px,7vw,72px);line-height:1.02;margin:0 0 16px}
