...
-- Validated against a live PostgreSQL 16 instance (see docs/db-portability.md).
...
CREATE TABLE IF NOT EXISTS courses (
  ...
  pass_code     TEXT NOT NULL DEFAULT '',        -- access_type=restricted: any member holding this pass gets in
