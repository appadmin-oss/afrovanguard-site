...
function baseCss(): string {
    return 'body,table,td,a{-webkit-text-size-adjust:100%;}table{border-collapse:collapse;}'
        ...
        . '.brand{font-family:\'Cormorant SC\',Georgia,serif;font-size:26px;font-weight:700;color:#fff;}'
        ...
        . 'h1{font-family:\'Cormorant SC\',Georgia,serif;font-size:28px;margin:0 0 20px;color:#111;line-height:1.2;}'
